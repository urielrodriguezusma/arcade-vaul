// Port de references/started-games/02-asteroids/game.js a un motor aislado.
// Todo el estado vive dentro de la instancia creada por createAsteroidsGame.
...
// Replica los tokens de app/globals.css
const COLORS = {
  bg: "#000",
  yellow: "#f5ff00", // --yellow: nave
  cyan: "#00f5ff", // --cyan: asteroides y partículas
  magenta: "#ff006e", // --magenta: balas y propulsor
  green: "#00ff88", // --green: power-up
};
...
export function createAsteroidsGame(
  ...
  if (!maybeCtx) throw new Error("Canvas 2D no disponible");
  ...
  function onKeyDown(e: KeyboardEvent) {
    if (!GAME_KEYS.has(e.code) || isTypingTarget(e.target)) return;
    e.preventDefault();
